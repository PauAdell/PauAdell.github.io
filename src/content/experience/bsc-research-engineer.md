...
<img src="/experience/opengl-unity-texture-share.png" alt="Diagram: the OpenGL program writes a rendered texture into shared memory, and Unity reads it from there." style="max-width: clamp(260px, 60%, 420px); margin: 0 auto; display: block;" />
